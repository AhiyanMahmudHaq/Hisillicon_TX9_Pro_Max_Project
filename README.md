...
The primary resource for learning how to build the customized variant of Armbian GNU/Linux for this exact TV box are Wikipedia pages and documentation from [linux-sunxi.org](linux-sunxi.org) which provide information about core concepts that are mandatory to understand ARM (ARM64) architecture's system software.
